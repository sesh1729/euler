...
def lcm_for_all_n_till(n):
    ...
    for i in range(n,1,-1):
        ...
        for factor in current_factor_numbers:
            if factor in prime_factor_numbers:
                prime_factor_exponents[prime_factor_numbers.index(factor)] = max(prime_factor_exponents[prime_factor_numbers.index(factor)],current_factor_exponents[current_factor_numbers.index(factor)])
            else:
    ...
    return prime_factor_numbers, prime_factor_exponents,lcm

#prime_factors(4)
lcm_for_all_n_till(20)
